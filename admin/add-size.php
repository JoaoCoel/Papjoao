        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="size-list.php">Lista de tamanhos</a></li>
                    <li class="breadcrumb-item active">Adicionar tamanho</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
<form action="confirm-add-size.php" method="post" enctype="multipart/form-data">
        <!-- Checkout Start -->
        <div class="checkout">
            <div class="container-fluid"> 
                <div class="row">
                            ...
                            <div class="billing-address">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" name="nomeTamanho" type="text" placeholder="">
                                    </div>
