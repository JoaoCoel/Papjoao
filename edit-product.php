                            ...
                            <div class="billing-address">
                                <div class="row">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="checkbox" class="custom-control-input" id="destacar" name="payment">
                                        <label class="custom-control-label" for="destacar">Destacar produto</label>
                                    </div>
                                    <!--div class="col-md-12">
                        ...
                        <div class="checkout-inner">
                            ...
                            <div class="checkout-payment">
                                ...
                                <div class="checkout-btn">
                                    <button input type="submit">Alterar</button>
                                </div>
                            </div>
                        </div>
                    </div>
