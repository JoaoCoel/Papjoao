            ...
            <div class="col-lg-4 sidebar">
                <div class="sidebar-widget category">
                    ...
                    <nav class="navbar bg-light">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="product-list.php?cat=2"><i class="fa fa-child"></i>Crianças & Bébés</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="sidebar-widget brands">
                    ...
                    <ul>
                        <li><a href="product-list.php?tip=1">Calças </a><span><?php echo contaCoisas($con,1); ?></span></li>
                        <li><a href="product-list.php?tip=2">Saias </a><span><?php echo contaCoisas($con,2); ?></span></li>
                        <li><a href="product-list.php?tip=3">Camisolas </a><span><?php echo contaCoisas($con,3); ?></span></li>
                        <li><a href="product-list.php?tip=4">Vestidos</a><span><?php echo contaCoisas($con,4); ?></span></li>
                        <li><a href="product-list.php?tip=5">Casacos </a><span><?php echo contaCoisas($con,5); ?></span></li>
                        <li><a href="product-list.php?tip=6">Camisas</a><span><?php echo contaCoisas($con,6); ?></span></li>
                    </ul>
                </div>
                <div class="sidebar-widget brands">
