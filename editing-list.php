            ...
            <th colspan="4" width="20%">Opções</th>
                ...
                echo "<table>";
                    while($dados=mysqli_fetch_array($result)){
                        ...
                        echo "<tr>";
                        echo "<td width='10%'>".$dados['produtoId']."</td>";
                        echo "<td width='10%'>".$dados['produtoNome']."</td>";
                        echo "<td width='10%'>".$dados['produtoPreco']."</td>";
                        echo "<td width='10%'>".$dados['categ']."</td>";
                        echo "<td width='10%'>".$dados['tipo']."</td>";
                        echo "<td width='5%'>".$dados['produtoDestaque']."</td>";
                        echo "<td width='15%'><img width=100px src=\"../../".$dados['produtoImagemURL']."\"></td>";
